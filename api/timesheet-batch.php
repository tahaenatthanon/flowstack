<?php
// POST /api/timesheet-batch.php
// Creates multiple tasks as timesheet entries in one request
...
$validWorkTypes = ['work', 'meeting', 'ot', 'onsite'];
$typeLabels = [
...
foreach ($entries as $i => $entry) {
    $workType    = in_array($entry['work_type'] ?? '', $validWorkTypes) ? ($entry['work_type'] ?? 'work') : 'work';
    ...
    if ($parentTaskId && !isValidUUID($parentTaskId)) {
