...
import { useUpdateTaskHoursEntry, useTasks } from '@/hooks/useProjectData';
import ProjectCombobox from '@/components/ProjectCombobox';
import { useToast } from '@/hooks/use-toast';
import { Dialog, DialogContent, DialogHeader, DialogTitle, DialogTrigger } from '@/components/ui/dialog';
import { Pencil } from 'lucide-react';

interface EditTaskHoursEntryDialogProps {
  entry: any;
  onSuccess?: () => void;
  open?: boolean;
...
const EditTaskHoursEntryDialog = ({ entry, onSuccess, open: externalOpen, onOpenChange: externalOnOpenChange }: EditTaskHoursEntryDialogProps) => {
  ...
  return (
    <Dialog open={open} onOpenChange={(v) => { if (!v && updateEntry.isPending) return; setOpen(v); }}>
...
export default EditTaskHoursEntryDialog;
