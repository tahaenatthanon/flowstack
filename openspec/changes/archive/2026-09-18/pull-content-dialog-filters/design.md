...
- **[Risk]** ถ้าลืมแยก React Query key (Decision 4) จะเกิด cache bleed — เปิด Content Planner ก่อนแล้วเปิด "ดึงคอนเทนท์" อาจเห็น cache เก่าที่ยังไม่กรอง หรือกลับกัน → **Mitigation:** ทดสอบเปิดทั้งสองหน้าในลำดับต่างกันระหว่าง apply เพื่อยืนยันไม่ปนกัน
