...
- [x] 2.1 เปิดหน้าต่าง "ดึงคอนเทนต์" เลือกคอนเทนต์ ("เลือกคอนเทนต์นี้") ให้ dialog "สร้างแคมเปญใหม่" เปิดทับ แล้วขยับเมาส์ผ่านโซนมุมขวาล่าง (ตำแหน่ง toast viewport) ซ้ำๆ ต่อเนื่อง — ยืนยันว่า toast "นำเข้าบทความแล้ว" ยังหายไปภายใน ~5 วินาที ไม่ค้าง (ทดสอบด้วย MutationObserver + จำลอง pointermove ต่อเนื่องบน viewport 700ms x 8 ครั้ง toast หายจาก DOM สมบูรณ์)
- [x] 2.2 ทดสอบ toast อีกจุดหนึ่ง (การเปิด dialog "ดึงคอนเทนต์" ครั้งแรกโดยไม่มีการโต้ตอบใดๆ กับ viewport) — ยืนยันว่ายังหายไปตามปกติภายในไม่กี่วินาที ไม่เร็ว/ช้าผิดปกติ
