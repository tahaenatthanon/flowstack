# approval-detail-quality-display Specification

## Purpose

แสดงผลตรวจ SEO/AEO ในหน้ารายละเอียดเนื้อหาฝั่งอนุมัติ (`ContentDetailView`, `context='approval'`) เป็นข้อมูลประกอบการตัดสินใจของผู้อนุมัติเท่านั้น — แสดงทันทีตอนเปิดดู ไม่บล็อกปุ่มอนุมัติ และไม่แสดงซ้ำใน dialog ยืนยัน (ที่มา: change `approval-seo-advisory`, คู่กับการตัด SEO/AEO gate ออกจากขออนุมัติ/เผยแพร่ใน `quality-required-gate`)
