# video-creation-options Specification

## Purpose

กำหนดตัวเลือกวิดีโอตอนสร้างคอนเทนต์ (ความยาว 30/45/60/90 วินาที, อัตราส่วนวิดีโอ 9:16 | 16:9, ความละเอียดวิดีโอ 720p | 1080p) การเก็บลง content item การล็อกค่าหลังสร้าง การแปลงข้อมูลเดิม และการกันไม่ให้สคริปต์ปนในแคปชั่น — ที่มา: change `video-creation-options`
