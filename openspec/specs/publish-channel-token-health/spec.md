# publish-channel-token-health Specification

## Purpose

ติดตามอายุ credentials ของช่องทางเผยแพร่ให้รู้ล่วงหน้าก่อนหมดอายุ แทนที่จะรู้ตอนโพสต์ล้มเหลว — `publish_channels` เดิมมีแต่ `credentials_encrypted` ไม่มีคอลัมน์เก็บวันหมดอายุ ทั้งที่ Graph API `debug_token` บอกวันหมดอายุได้ตรง ๆ และ Facebook token หมดอายุไปแล้ว 3 ครั้งโดยไม่มีใครรู้ล่วงหน้า
