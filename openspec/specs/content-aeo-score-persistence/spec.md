# content-aeo-score-persistence Specification

## Purpose

กำหนดให้คะแนน SEO และคะแนน AEO ของ content item แต่ละชิ้น (คนละระบบประเมิน คนละคะแนน) ต้องถูกบันทึกถาวรลงฐานข้อมูลหลัง generate/repair เสร็จ แทนที่จะใช้แค่ตอบกลับ frontend ชั่วคราว เพื่อให้ดูย้อนหลังได้ตอนอนุมัติ
