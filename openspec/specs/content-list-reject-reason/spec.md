# content-list-reject-reason

## Purpose

แสดงเหตุผลที่ขอแก้ไข/ปฏิเสธ (`reject_reason`) ของ content item ใน Tab "ผลงานทั้งหมด" ทั้งในกล่องแก้ไขเนื้อหาและในแถวรายการโดยตรง เพื่อให้ผู้สร้างคอนเทนต์เห็นเหตุผลจากผู้อนุมัติโดยไม่ต้องไปค้นหา
