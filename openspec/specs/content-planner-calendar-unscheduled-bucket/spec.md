# content-planner-calendar-unscheduled-bucket Specification

## Purpose

กำหนดให้มุมมอง Calendar ของ Content Planner (`ContentPlannerCalendar`) ต้องไม่ทำให้ content item ที่ไม่มีวันที่กำหนด (`scheduled_date`) หายไปเงียบๆ จากมุมมอง — item เหล่านี้ต้องแสดงในกลุ่ม "ยังไม่กำหนดวันที่" เหนือ grid เสมอ พร้อมรองรับการลากไปกำหนดวันที่และคลิกแก้ไขได้เหมือน item ที่มีวันที่แล้ว
