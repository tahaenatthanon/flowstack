# email-campaign-send-failure-visibility Specification

## Purpose

TBD - created by archiving change surface-campaign-send-failure-reason. Update Purpose after archive.
...
หน้าจัดการแคมเปญอีเมล SHALL แสดงปุ่มเปิด "Log การส่งอีเมล" สำหรับแคมเปญใดๆ ที่เคยมีการพยายามส่งแล้ว โดยไม่ขึ้นกับว่าสถานะปัจจุบันของแคมเปญคืออะไร
