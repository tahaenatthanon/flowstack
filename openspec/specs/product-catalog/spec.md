...
TBD - จัดการ product catalog ของแต่ละ tenant (โครงสร้างข้อมูลสินค้า/บริการ, CRUD API, การ bootstrap จาก brand context เดิม, และ UI จัดการบนหน้า Brand Setting) เพื่อเป็นแหล่งข้อมูลสินค้าให้ฟีเจอร์อื่น เช่น การสร้างแคมเปญด้วย AI นำไปใช้อ้างอิง
