...
กำหนดให้การเลือกประเภท Article/Video ถูกส่งจาก Frontend และบันทึกที่ Backend อย่างถูกต้อง เพื่อให้ AI Generation Flow เลือก prompt ตามประเภทที่ผู้ใช้เลือกจริง
