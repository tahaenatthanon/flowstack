# content-dashboard-tabs Specification

## Purpose

กำหนดโครงสร้างแท็บ (ภาพรวม/วิเคราะห์) ของหน้าแดชบอร์ดคอนเทนต์ (`ContentDashboardPage`) พร้อมการผูกสถานะแท็บกับ URL query parameter
