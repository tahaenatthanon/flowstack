...
กำหนดว่า Content Type (Article/Video) และ Platform ที่เลือกเป็นคนละแกนที่เป็นอิสระต่อกัน — Content Type คุมแค่วิธีเขียน Core Article เท่านั้น ส่วน Platform Output shape (Script + Script Sections / ใช้ Core Article ตรงๆ) ถูก derive จากชนิดของ platform ที่เลือกจริง ไม่ใช่จาก Content Type ทำให้สร้าง Content ที่มีทั้ง Website, Social post, และ Video script ในการรันเดียวได้ โดย Core Article มีเนื้อหาเสมอไม่ว่า Content Type จะเป็นอะไร
