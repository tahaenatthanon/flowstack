# video-prompt-backfill Specification

## Purpose

ให้ผู้ใช้เขียน `video_prompt` ย้อนหลังด้วย AI เมื่อ scene ไม่มีค่านี้ (เช่น content เก่าที่สร้างก่อนมี field นี้ หรือ AI เขียนตอน generate content ไม่สำเร็จ) โดยไม่ต้องพิมพ์เอง — ใช้ text model เขียนคำสั่งการเคลื่อนไหวจาก `visual_prompt` ที่มีอยู่แล้ว
