# content-dashboard-website-placeholder Specification

## Purpose

กำหนด sub-tab "เว็บไซต์" แบบ placeholder ของแท็บ "วิเคราะห์" — แสดง stat card 4 ใบเป็น em dash และ notice card ภาษาไทย (ยังไม่เชื่อม Google Analytics 4 / Search Console)
