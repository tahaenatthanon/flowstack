# approval-type-filter Specification

## Purpose

กำหนดพฤติกรรมของ Type Filter Dropdown ในหน้า "รายการอนุมัติ" (`/content-approval`) สำหรับกรองรายการตาม `content_type` (บทความ, วีดีโอ) รวมถึงตำแหน่งการวางใน toolbar และการทำงานร่วมกับ Tab Navigation และช่องค้นหา
