...
กำหนดการตรวจ Quality (SEO/AEO) ซ้ำของคอนเทนต์ที่บันทึกแล้ว โดยไม่ generate เนื้อหาใหม่ และการเซ็ต marker `quality_checked_at` ให้สอดคล้องกับความหมายเดิม (ประเมินแล้ว ไม่ใช่ผ่านแล้ว)
