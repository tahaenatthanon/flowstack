# toast-notification-lifecycle Specification

## Purpose

กำหนดพฤติกรรมการแสดงและหายไปของ toast notification ทั่วทั้งระบบ (ผ่าน `useToast`/`toast()` ใน `src/hooks/use-toast.ts`) — โดยเฉพาะการรับประกันว่า toast จะหายไปภายในเวลาที่คาดเดาได้แน่นอน ไม่ว่าเมาส์ผู้ใช้จะอยู่ตรงไหนหรือมี dialog อื่นเปิดทับ toast viewport หรือไม่ก็ตาม
