# content-dashboard-analytics-subtabs Specification

## Purpose

กำหนด sub-tab ระดับที่สองของแท็บ "วิเคราะห์" ในแดชบอร์ดคอนเทนต์ (โซเชียล/เว็บไซต์/เนื้อหา) พร้อมการผูกสถานะกับ URL query parameter `view` และ visual style ตาม pattern Helpdesk
